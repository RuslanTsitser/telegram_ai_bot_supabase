...
4 - Очень высокая активность, интенсивные ежедневные тренировки`,
  ...
  image_analysis_limit_reached:
    "🚫 Достигнут дневной лимит анализов по изображениям!",
  image_analysis_remaining:
    "📸 Осталось анализов по изображениям сегодня: {count}",
  ...
  onboarding_support:
    "Для получения технической поддержки используйте команду /support",
  ...
  subscription_trial_activation_error:
    "❌ Ошибка при активации пробного периода",
  subscription_trial_activated: "✅ Пробный период активирован!",
  subscription_trial_activated_message:
    '🎉 Пробный период "{planName}" активирован!\n\nДоступен до: {date}\n\nТеперь у вас есть полный доступ ко всем функциям!',
  subscription_invoice_created: "✅ Создан счет для оплаты",
  subscription_invoice_error: "❌ Ошибка при создании счета",
  subscription_trial_activation_error_reply:
    "❌ Ошибка при активации пробного периода",
  subscription_trial_activated_reply: "✅ Пробный период активирован!",
  subscription_trial_auto_activated:
    "🎉 Вы достигли лимита бесплатных запросов. Автоматически активирован пробный период!",
  subscription_days: ["день", "дня", "дней"],

  // Вода
  water_sips: "Пару глотков",
  water_glass: "Стакан",
  water_recorded: "✅ Запись добавлена",
  water_error: "❌ Ошибка при записи воды",

  // Оценка анализа
  analysis_like: "👍 Лайк",
  analysis_dislike: "👎 Дизлайк",
} as const;
