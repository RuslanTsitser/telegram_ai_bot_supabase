...
const WATER_MESSAGES = {
  ru: [
    ...
    "🌊 Пейте воду регулярно для поддержания водного баланса.",
    ...
    "🌊 Регулярное питье воды помогает контролировать аппетит.",
  ],
  en: [
    ...
    "🌊 Drink water regularly to maintain water balance.",
    ...
    "🌊 Regular water drinking helps control appetite.",
  ],
};

const MEAL_MESSAGES = {
  ru: [
    "🍽️ Время поесть! Вашему организму нужна энергия.",
    "🥗 Не пропускайте приемы пищи! Это важно для метаболизма.",
    "🍎 Сбалансированное питание - залог здоровья. Время поесть!",
    "🥘 Регулярные приемы пищи помогают поддерживать стабильный уровень сахара.",
    "🍽️ Еда дает энергию для продуктивного дня. Время поесть!",
    "🥗 Правильное питание улучшает концентрацию. Не забывайте поесть!",
    "🍎 Регулярные приемы пищи помогают контролировать вес.",
    "🥘 Еда - это топливо для вашего тела. Время заправиться!",
  ],
  en: [
    "🍽️ Time to eat! Your body needs energy.",
    "🥗 Don't skip meals! It's important for metabolism.",
    "🍎 Balanced nutrition is the key to health. Time to eat!",
    "🥘 Regular meals help maintain stable blood sugar levels.",
    "🍽️ Food gives energy for a productive day. Time to eat!",
    "🥗 Proper nutrition improves concentration. Don't forget to eat!",
    "🍎 Regular meals help control weight.",
    "🥘 Food is fuel for your body. Time to refuel!",
  ],
};
